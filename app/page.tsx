        ...
        <section className="hero">
          <div>
            <span className="hero__meta">
              Ready for Vercel deployments • archiving & restores
            </span>
            <h1 className="hero__title">
              Archive without losing velocity or compliance posture.
            </h1>
            <p className="hero__lead">
              Build a durable archive for Vercel projects: define policies,
              rehearse restores, and keep every deployment discoverable with
              evidence trails.
            </p>
            <div className="hero__actions">
              <button className="btn btn--primary">
                Launch archive console
                <span className="btn__badge">live</span>
              </button>
              <button className="btn btn--ghost">
                View Vercel playbook
                <span className="btn__badge">coming</span>
              </button>
            </div>
            <div className="stack" style={{ marginTop: "18px" }}>
              <span className="pill pill--accent">Cold + warm storage lanes</span>
              <span className="pill pill--warm">Retention proof built-in</span>
              <span className="pill">Restores synced to branches</span>
            </div>
          </div>
