  ...
  return (
    <div className="card">
      <div className="section__header" style={{ marginBottom: "10px" }}>
        <div>
          <p className="section__title">Drop a file to stash</p>
          <p className="muted">
            On Vercel, uploads go to Blob when <code>BLOB_READ_WRITE_TOKEN</code> is set. In local
            dev, they land in <code>archives/</code>.
          </p>
        </div>
